# Feature Transformation Analysis, All helpful Features - This script is used to analyze effect all supposedly benifical features have on linear regression model forecasting

"""
    Results of Feature Analysis: All "helpful" features did not provide any significant benifit. 
    Features, MAPE, MAE, R^2, MSE, RMSE
    Base + "Helpful" Tranformations,  0.06934824281668837 ,  640.6614418660662 ,  0.8925016009403614 ,  743875.5941056712 ,  862.4822282839637
...
X_main = X[['Year', 'Month', 'Day', 'Hour', 'WEEKEND', 'WEEKDAY', 'HOLIDAY', 'SEASON', 'Temp (C) - Original', 'Dew Point Temp (C) - Original', 'Rel Hum (%) - Original', 'Wind Spd (km/h) - Original', 'WIND CHILL CALCULATION - Original', 'Temp (C) - Square' ,'Temp (C) - Cube' ,'Temp (C) - Sine' ,'Temp (C) - Cosine' ,'Temp (C) - Tangent' ,'Temp (C) - Square Root' , 'Temp (C) - Logarithm','Temp (C) - Inverse' ,'Dew Point Temp (C) - Inverse' ,'Wind Spd (km/h) - Square' ,'Wind Spd (km/h) - Cube' ,'Wind Spd (km/h) - Sine', 'Wind Spd (km/h) - Cosine', 'Wind Spd (km/h) - Tangent', 'Wind Spd (km/h) - Logarithm', 'Wind Spd (km/h) - Square Root', 'Wind Spd (km/h) - Inverse', 'WIND CHILL CALCULATION - Cube', 'WIND CHILL CALCULATION - Sine', 'WIND CHILL CALCULATION - Tangent', 'WIND CHILL CALCULATION - Inverse' ]]
...
print("Base + \"Helpful\" Tranformations, ", mape, ", ", mae, ", ", r2, ", ", mse, ", ", rmse)