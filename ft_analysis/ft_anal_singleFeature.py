# Feature Transformation Analysis, Single Features - This script is used to analyze effect individual features have on linear regression model forecasting

"""
    Results of Single Feature Analysis:
    MAPE of Ridge Regression model with only Base Featurs
        Base Features	0.069400006

    List of Features and their MAPEs - All slightly improved off of MAPE with only base features (from best to worst improvement)
        Temp (C) - Cosine 	0.069344297
        Temp (C) - Square 	0.069345623
        Temp (C) - Tangent 	0.06935759
        Temp (C) - Cube 	0.069361333
        Temp (C) - Sine 	0.069372527
        Temp (C) - Square Root 	0.069372777
        Temp (C) - Inverse 	0.069375029
        Wind Spd (km/h) - Square Root 	0.069375856
        Wind Spd (km/h) - Square 	0.069379057
        Wind Spd (km/h) - Cosine 	0.069379062
        Wind Spd (km/h) - Cube 	0.069380859
        Temp (C) - Logarithm 	0.069384614
        Wind Spd (km/h) - Inverse 	0.069386552
        Wind Spd (km/h) - Tangent 	0.069390339
        Wind Spd (km/h) - Sine 	0.069390851
        Wind Spd (km/h) - Logarithm 	0.069392234
        WIND CHILL CALCULATION - Sine 	0.069392371
        WIND CHILL CALCULATION - Inverse 	0.069394714
        WIND CHILL CALCULATION - Cube 	0.069395279
        Dew Point Temp (C) - Inverse 	0.069397468
        WIND CHILL CALCULATION - Tangent 	0.069399279
